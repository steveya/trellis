...
| `QUA-818` | Proof follow-on: swaption analytical/tree/MC parity drift (`T73`) | Done |
| `QUA-819` | Proof follow-on: cap/floor fresh-build stability and reference-target evidence (`E22`) | Done |
