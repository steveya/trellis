...
SEMANTIC_CONCEPT_REGISTRY: tuple[SemanticConceptDefinition, ...] = (
    ...
    _concept(
        ...
        scope="single-underlier European fixed-strike continuous-lookback contracts",
        description=(
            "Single-underlier European lookback option whose fixed strike and "
            "continuous running extremum are priced under exact scalar diffusion."
        ),
        concept_role="product_contract",
        aliases=(
            "lookback_option",
    ...
    _concept(
        ...
        semantic_version="c2.1",
        scope="single-underlier holder-controlled vanilla option contracts with bounded early exercise",
        description="Single-underlier vanilla option with holder-controlled American or Bermudan exercise.",
        concept_role="product_contract",
        aliases=(
            "american_option",
            "bermudan_option",
        ...
        compatibility_wrappers=("american_option",),
        required_contract_fields=(
            "underlier_structure",
            "payoff_rule",
            "settlement_rule",
        ...
        required_primitives=("exercise_lattice", "pde_theta_1d"),
        route_helpers=(
        ...
        example_requests=(
            "Bermudan put on AAPL with quarterly exercise dates",
        ),
        cue_phrases=(
            "american put",
            "american call",
    ...
    _concept(
        ...
        description=(
            "Interest-rate cap or floor represented as a schedule-driven strip of "
            "period rate options with shared forward, discount, and volatility inputs."
        ),
        concept_role="product_contract",
        aliases=(
            "period_rate_option_strip",
        ),
        compatibility_wrappers=("cap", "floor"),
        required_contract_fields=(
            "underlier_structure",
            "payoff_rule",
            "settlement_rule",
        ...
        required_primitives=("analytical_black76",),
        route_helpers=("trellis.instruments.cap",),
        required_market_inputs=(
            "discount_curve",
            "forward_curve",
            "black_vol_surface",
        ...
        route_family="analytical",
        example_requests=(
            "5Y cap on SOFR with quarterly caplets under Black-76",
        ),
        cue_phrases=(
            "interest rate cap",
            "interest rate floor",
    ...
    _concept(
        ...
        semantic_version="c2.1",
        scope="single-index range-accrual trade-entry contracts with typed coupon and barrier terms",
        description=(
            "Single-index range-accrual contract that captures the reference index, "
            "coupon definition, accrual range bounds, schedule, settlement profile, "
            "and optional callability hooks."
        ),
        concept_role="product_contract",
        aliases=(
            "range_accrual",
        ...
        compatibility_wrappers=("range_note",),
        required_contract_fields=(
            "reference_index",
            "coupon_definition",
            "range_condition",
        ...
        route_helpers=("trellis.models.contingent_cashflows",),
        required_market_inputs=(
            "discount_curve",
            "forward_curve",
            "fixing_history",
        ...
        route_family="monte_carlo",
        example_requests=(
            "Range accrual note on SOFR paying 5.25% when SOFR stays between 1.50% and 3.25% on scheduled fixing dates.",
        ),
        cue_phrases=(
            "range accrual",
            "range note",
    ...
    _concept(
        ...
        semantic_version="c1.0",
        scope="basket credit derivative: tranche loss on a correlated reference portfolio",
        description=(
            "Synthetic CDO or tranche-style basket credit derivative. Requires "
            "basket default dependence modeling and a tranche-loss projection "
            "from the portfolio loss distribution."
        ),
        concept_role="product_contract",
        aliases=(
            "credit basket tranche",
            "cdo tranche",
            "synthetic cdo",
            "tranche",
            "cdo",
        ...
        route_family="copula_loss_distribution",
        example_requests=(
            "Price a 3% to 7% CDO tranche on a 100-name IG portfolio",
            "Compare Gaussian and Student-t copula prices for a mezzanine tranche",
        ),
        cue_phrases=(
            "cdo tranche",
            "synthetic cdo",
