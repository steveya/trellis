    ...
    market_data=MarketDataContract(
        required_inputs=(
            ...
            MarketInputSpec(
                ...
                capability="spot",
                aliases=("spot", "underlier_spot", "underlier_id"),
                connector_hint="Resolve the exact named underlier spot when the contract supplies underlier_id.",
            ),
            MarketInputSpec(
                input_id="fx_spot",
            ...
            MarketInputSpec(
                ...
                aliases=("vol_surface", "underlier_vol_surface", "underlier_vol_surface_key"),
                connector_hint="Resolve the exact named underlier surface when the contract supplies a key.",
            ),
            MarketInputSpec(
                input_id="fx_vol",
                description="Volatility input for the FX process.",
                capability="black_vol_surface",
                aliases=("fx_vol_surface", "fx_vol", "fx_vol_surface_key"),
                connector_hint="Resolve the exact named FX surface when the contract supplies a key.",
            ),
            MarketInputSpec(
