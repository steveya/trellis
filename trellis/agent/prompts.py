    ...
    *,
    ...
    if instrument_type in {"cds", "credit_default_swap"}:
        ...
        lines.extend([
            ...
            "- Import `build_period_schedule`, the declared calendar/schedule convention symbols, and every selected default-event, first-event-weight, cashflow-constructor, and cashflow-PV primitive directly and without aliases from its public Trellis module. Wildcard imports are never admitted. Do not shadow or rebind those names locally or at module scope.",
