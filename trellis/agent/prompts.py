    ...
    *,
    ...
    if instrument_type in {"cds", "credit_default_swap"}:
        ...
        lines.extend([
            ...
            "- Keep the interval loop as a reachable direct child of the period loop. Initialize each premium, protection, event-accrual, and valuation-accrual accumulator exactly once to `0.0`, update it only with additive `+=`, and never reassign it before return.",
