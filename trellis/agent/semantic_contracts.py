        ...
        _family_definition(
            ...
            method_surfaces=(
                _method_surface_definition(
                    ...
                    adapter_obligations=(
                        "resolve_basket_market_and_schedule_semantics",
                        "derive_domestic_rate_from_discount_factor",
                        "construct_correlated_gbm_from_resolved_vectors",
                        "bind_one_engine_grid_to_ranked_snapshot_state",
                        "apply_expiry_discount_and_notional_settlement",
                    ),
...
def _draft_period_rate_option_strip_contract(
    text: str,
    description: str,
    instrument_type: str | None,
    term_sheet,
...
def _build_semantic_draft_rules() -> tuple[SemanticDraftRule, ...]:
    ...
    return (
        ...
        SemanticDraftRule(
            ...
            builder=_draft_period_rate_option_strip_contract,
        ),
        SemanticDraftRule(
