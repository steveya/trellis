# Analytical Trace: `executor_build_20260329024508_d20e09fc`
- Trace type: `analytical`
- Route family: `pde_solver`
- Route name: `pde_theta_1d`
- Model: `pde_solver`
- Status: `ok`
- Created at: `2026-03-29T02:45:09.449915+00:00`
- Updated at: `2026-03-29T02:45:09.609213+00:00`
- Task ID: `executor_build_20260329024508_d20e09fc`
...
## Steps
- **trace** `executor_build_20260329024508_d20e09fc:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329024508_d20e09fc
  - Outputs:
    - `route`: {
  "family": "pde_solver",
  "model": "pde_solver",
  "name": "pde_theta_1d"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260329024508_d20e09fc:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329024508_d20e09fc:root`
    - Notes:
  ...
  "route": "pde_theta_1d"
      ...
      - `route_family`: pde_solver
      - `route_name`: pde_theta_1d
  - **instruction_lifecycle** `executor_build_20260329024508_d20e09fc:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329024508_d20e09fc:decomposition`
  ...
  - **assembly** `executor_build_20260329024508_d20e09fc:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.pde.theta_method"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329024508_d20e09fc:validation`
  ...
  - **output** `executor_build_20260329024508_d20e09fc:output`
