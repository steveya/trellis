# Analytical Trace: `executor_build_20260329025942_942c315b`
- Trace type: `analytical`
- Route family: `monte_carlo`
- Route name: `exercise_monte_carlo`
- Model: `exercise`
- Status: `ok`
- Created at: `2026-03-29T03:00:39.446641+00:00`
- Updated at: `2026-03-29T03:00:39.567911+00:00`
- Task ID: `executor_build_20260329025942_942c315b`
...
## Steps
- **trace** `executor_build_20260329025942_942c315b:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329025942_942c315b
  - Outputs:
    - `route`: {
  "family": "monte_carlo",
  "model": "exercise",
  "name": "exercise_monte_carlo"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260329025942_942c315b:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329025942_942c315b:root`
    - Notes:
  ...
  "route": "exercise_monte_carlo"
      ...
      - `route_family`: monte_carlo
      - `route_name`: exercise_monte_carlo
  - **instruction_lifecycle** `executor_build_20260329025942_942c315b:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329025942_942c315b:decomposition`
  ...
  - **assembly** `executor_build_20260329025942_942c315b:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.monte_carlo.stochastic_mesh"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329025942_942c315b:validation`
  ...
  - **output** `executor_build_20260329025942_942c315b:output`
