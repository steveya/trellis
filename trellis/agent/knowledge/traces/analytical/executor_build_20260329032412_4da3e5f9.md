# Analytical Trace: `executor_build_20260329032412_4da3e5f9`
- Trace type: `analytical`
- Route family: `monte_carlo`
- Route name: `monte_carlo_paths`
- Model: `monte_carlo`
- Status: `warning`
- Created at: `2026-03-29T03:24:30.920824+00:00`
- Updated at: `2026-03-29T03:24:31.056382+00:00`
- Task ID: `executor_build_20260329032412_4da3e5f9`

## Context
- `class_name`: 'GBMCallPayoff'
...
## Steps
- **trace** `executor_build_20260329032412_4da3e5f9:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329032412_4da3e5f9
  - Outputs:
    - `route`: {
  "family": "monte_carlo",
  "model": "monte_carlo",
  "name": "monte_carlo_paths"
    ...
    - `status`: warning
  - **semantic_resolution** `executor_build_20260329032412_4da3e5f9:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329032412_4da3e5f9:root`
    - Notes:
  ...
  "route": "monte_carlo_paths"
      ...
      - `route_family`: monte_carlo
      - `route_name`: monte_carlo_paths
  - **instruction_lifecycle** `executor_build_20260329032412_4da3e5f9:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329032412_4da3e5f9:decomposition`
  ...
  - **assembly** `executor_build_20260329032412_4da3e5f9:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.monte_carlo.engine"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329032412_4da3e5f9:validation`
  ...
  - **output** `executor_build_20260329032412_4da3e5f9:output`
