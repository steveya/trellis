...
- `spec_name`: 'NonUniformGridPDEPayoffSpec'

## Steps
- **trace** `executor_build_20260329132756_c4b3c3fd:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329132756_c4b3c3fd
  - Outputs:
    - `route`: {
  "family": "pde_solver",
  "model": "pde_solver",
  "name": "pde_theta_1d"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260329132756_c4b3c3fd:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329132756_c4b3c3fd:root`
    - Notes:
  ...
  "effective_instructions": [
    ...
    },
    {
      ...
      "source_kind": "route_card",
      "source_revision": "",
      "statement": "Construct a `Grid` and a terminal-condition ndarray before calling `theta_method_1d(grid, operator, terminal_condition, theta=...)`.",
      "status": "active",
      "supersedes": [],
      "title": "Route note 1",
      "updated_at": ""
  ...
  "route": "pde_theta_1d"
      ...
      - `route_family`: pde_solver
      - `route_name`: pde_theta_1d
  - **instruction_lifecycle** `executor_build_20260329132756_c4b3c3fd:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329132756_c4b3c3fd:decomposition`
  ...
  "define_operator_boundary_terminal_conditions"
      ...
      - `blockers`: []
      - `notes`: [
  "Construct a `Grid` and a terminal-condition ndarray before calling `theta_method_1d(grid, operator, terminal_condition, theta=...)`.",
  ...
  - **assembly** `executor_build_20260329132756_c4b3c3fd:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.pde.theta_method"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329132756_c4b3c3fd:validation`
  ...
  - **output** `executor_build_20260329132756_c4b3c3fd:output`
