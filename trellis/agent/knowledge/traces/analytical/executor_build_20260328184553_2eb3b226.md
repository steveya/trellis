# Analytical Trace: `executor_build_20260328184553_2eb3b226`
- Trace type: `analytical`
- Route family: `monte_carlo`
- Route name: `monte_carlo_paths`
- Model: `monte_carlo`
- Status: `ok`
- Created at: `2026-03-28T18:45:53.831396+00:00`
- Updated at: `2026-03-28T18:45:53.989395+00:00`
- Task ID: `executor_build_20260328184553_2eb3b226`
...
## Steps
- **trace** `executor_build_20260328184553_2eb3b226:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260328184553_2eb3b226
  - Outputs:
    - `route`: {
  "family": "monte_carlo",
  "model": "monte_carlo",
  "name": "monte_carlo_paths"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260328184553_2eb3b226:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260328184553_2eb3b226:root`
    - Notes:
  ...
  "Payoff"
    ...
    - Outputs:
      ...
      - `route_family`: monte_carlo
      - `route_name`: monte_carlo_paths
  - **decomposition** `executor_build_20260328184553_2eb3b226:decomposition`
  ...
  - **assembly** `executor_build_20260328184553_2eb3b226:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.monte_carlo.engine"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260328184553_2eb3b226:validation`
  ...
  - **output** `executor_build_20260328184553_2eb3b226:output`
