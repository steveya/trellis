...
## Steps
- **trace** `executor_build_20260329030310_52ba10ba:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329030310_52ba10ba
  - Outputs:
    - `route`: {
  "family": "monte_carlo",
  "model": "monte_carlo",
  "name": "monte_carlo_paths"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260329030310_52ba10ba:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329030310_52ba10ba:root`
    - Notes:
  ...
  "route": "monte_carlo_paths"
      ...
      - `route_family`: monte_carlo
      - `route_name`: monte_carlo_paths
  - **instruction_lifecycle** `executor_build_20260329030310_52ba10ba:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329030310_52ba10ba:decomposition`
  ...
  - **assembly** `executor_build_20260329030310_52ba10ba:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.monte_carlo.engine"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329030310_52ba10ba:validation`
  ...
  - **output** `executor_build_20260329030310_52ba10ba:output`
