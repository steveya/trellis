# Analytical Trace: `executor_build_20260328184515_dfd0241e`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `analytical_black76`
- Model: `analytical`
- Status: `warning`
- Created at: `2026-03-28T18:45:16.023949+00:00`
- Updated at: `2026-03-28T18:45:16.163501+00:00`
- Task ID: `executor_build_20260328184515_dfd0241e`
...
## Steps
- **trace** `executor_build_20260328184515_dfd0241e:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260328184515_dfd0241e
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "analytical",
  "name": "analytical_black76"
    ...
    - `status`: warning
  - **semantic_resolution** `executor_build_20260328184515_dfd0241e:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260328184515_dfd0241e:root`
    - Notes:
  ...
  "instrument_type_not_provided"
    ...
    - Outputs:
      ...
      - `route_family`: analytical
      - `route_name`: analytical_black76
  - **decomposition** `executor_build_20260328184515_dfd0241e:decomposition`
  ...
  - **assembly** `executor_build_20260328184515_dfd0241e:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.core.date_utils"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260328184515_dfd0241e:validation`
  ...
  - **output** `executor_build_20260328184515_dfd0241e:output`
