# Analytical Trace: `executor_build_20260328184555_6f09274d`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `quanto_adjustment_analytical`
- Model: `unknown`
- Status: `ok`
- Created at: `2026-03-28T18:45:55.255092+00:00`
- Updated at: `2026-03-28T18:45:55.400391+00:00`
- Task ID: `executor_build_20260328184555_6f09274d`
...
## Steps
- **trace** `executor_build_20260328184555_6f09274d:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260328184555_6f09274d
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "unknown",
  "name": "quanto_adjustment_analytical"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260328184555_6f09274d:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260328184555_6f09274d:root`
    - Notes:
  ...
  "discount_factor_from_zero_rate"
    ...
    - Outputs:
      ...
      - `route_family`: analytical
      - `route_name`: quanto_adjustment_analytical
  - **decomposition** `executor_build_20260328184555_6f09274d:decomposition`
  ...
  - **assembly** `executor_build_20260328184555_6f09274d:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.analytical.quanto"
      ...
      - `route_helper`: trellis.models.analytical.quanto.price_quanto_option_analytical
  - **validation** `executor_build_20260328184555_6f09274d:validation`
  ...
  - **output** `executor_build_20260328184555_6f09274d:output`
