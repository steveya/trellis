# Analytical Trace: `executor_build_20260328184554_7211d87c`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `quanto_adjustment_analytical`
- Model: `unknown`
- Status: `ok`
- Created at: `2026-03-28T18:45:54.687132+00:00`
- Updated at: `2026-03-28T18:45:54.835776+00:00`
- Task ID: `executor_build_20260328184554_7211d87c`
...
## Steps
- **trace** `executor_build_20260328184554_7211d87c:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260328184554_7211d87c
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "unknown",
  "name": "quanto_adjustment_analytical"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260328184554_7211d87c:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260328184554_7211d87c:root`
    - Notes:
  ...
  "discount_factor_from_zero_rate"
    ...
    - Outputs:
      ...
      - `route_family`: analytical
      - `route_name`: quanto_adjustment_analytical
  - **decomposition** `executor_build_20260328184554_7211d87c:decomposition`
  ...
  - **assembly** `executor_build_20260328184554_7211d87c:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.analytical.quanto"
      ...
      - `route_helper`: trellis.models.analytical.quanto.price_quanto_option_analytical
  - **validation** `executor_build_20260328184554_7211d87c:validation`
  ...
  - **output** `executor_build_20260328184554_7211d87c:output`
