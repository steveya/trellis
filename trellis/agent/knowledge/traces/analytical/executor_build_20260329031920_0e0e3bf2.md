# Analytical Trace: `executor_build_20260329031920_0e0e3bf2`
- Trace type: `analytical`
- Route family: `pde_solver`
- Route name: `pde_theta_1d`
- Model: `pde_solver`
- Status: `warning`
- Created at: `2026-03-29T03:19:41.273474+00:00`
- Updated at: `2026-03-29T03:19:41.398654+00:00`
- Task ID: `executor_build_20260329031920_0e0e3bf2`

## Context
- `class_name`: 'FDThetaMethodEuropeanPayoff'
...
- `spec_name`: 'FDThetaMethodEuropeanSpec'

## Steps
- **trace** `executor_build_20260329031920_0e0e3bf2:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329031920_0e0e3bf2
  - Outputs:
    - `route`: {
  "family": "pde_solver",
  "model": "pde_solver",
  "name": "pde_theta_1d"
    ...
    - `status`: warning
  - **semantic_resolution** `executor_build_20260329031920_0e0e3bf2:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329031920_0e0e3bf2:root`
    - Notes:
  ...
  "route": "pde_theta_1d"
      ...
      - `route_family`: pde_solver
      - `route_name`: pde_theta_1d
  - **instruction_lifecycle** `executor_build_20260329031920_0e0e3bf2:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329031920_0e0e3bf2:decomposition`
  ...
  - **assembly** `executor_build_20260329031920_0e0e3bf2:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.pde.theta_method"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329031920_0e0e3bf2:validation`
  ...
  - **output** `executor_build_20260329031920_0e0e3bf2:output`
