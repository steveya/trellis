# Analytical Trace: `executor_build_20260328154124_681069ec`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `analytical_black76`
- Model: `analytical`
- Status: `warning`
- Created at: `2026-03-28T15:41:24.623715+00:00`
- Updated at: `2026-03-28T15:41:24.781862+00:00`
- Task ID: `executor_build_20260328154124_681069ec`
...
## Steps
- **trace** `executor_build_20260328154124_681069ec:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260328154124_681069ec
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "analytical",
  "name": "analytical_black76"
    ...
    - `status`: warning
  - **semantic_resolution** `executor_build_20260328154124_681069ec:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260328154124_681069ec:root`
    - Notes:
  ...
  "instrument_type_not_provided"
    ...
    - Outputs:
      ...
      - `route_family`: analytical
      - `route_name`: analytical_black76
  - **decomposition** `executor_build_20260328154124_681069ec:decomposition`
  ...
  - **assembly** `executor_build_20260328154124_681069ec:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.core.date_utils"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260328154124_681069ec:validation`
  ...
  - **output** `executor_build_20260328154124_681069ec:output`
