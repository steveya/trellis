# Analytical Trace: `executor_build_20260328190921_0ae0b460`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `quanto_adjustment_analytical`
- Model: `unknown`
- Status: `ok`
- Created at: `2026-03-28T19:09:21.646983+00:00`
- Updated at: `2026-03-28T19:09:21.796449+00:00`
- Task ID: `executor_build_20260328190921_0ae0b460`
...
## Steps
- **trace** `executor_build_20260328190921_0ae0b460:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260328190921_0ae0b460
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "unknown",
  "name": "quanto_adjustment_analytical"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260328190921_0ae0b460:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260328190921_0ae0b460:root`
    - Notes:
  ...
  "discount_factor_from_zero_rate"
    ...
    - Outputs:
      ...
      - `route_family`: analytical
      - `route_name`: quanto_adjustment_analytical
  - **decomposition** `executor_build_20260328190921_0ae0b460:decomposition`
  ...
  - **assembly** `executor_build_20260328190921_0ae0b460:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.analytical.quanto"
      ...
      - `route_helper`: trellis.models.analytical.quanto.price_quanto_option_analytical
  - **validation** `executor_build_20260328190921_0ae0b460:validation`
  ...
  - **output** `executor_build_20260328190921_0ae0b460:output`
