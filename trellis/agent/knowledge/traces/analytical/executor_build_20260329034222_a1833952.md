# Analytical Trace: `executor_build_20260329034222_a1833952`
- Trace type: `analytical`
- Route family: `pde_solver`
- Route name: `pde_theta_1d`
- Model: `pde_solver`
- Status: `ok`
- Created at: `2026-03-29T03:42:22.997906+00:00`
- Updated at: `2026-03-29T03:42:23.173154+00:00`
- Task ID: `executor_build_20260329034222_a1833952`
...
## Steps
- **trace** `executor_build_20260329034222_a1833952:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329034222_a1833952
  - Outputs:
    - `route`: {
  "family": "pde_solver",
  "model": "pde_solver",
  "name": "pde_theta_1d"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260329034222_a1833952:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329034222_a1833952:root`
    - Notes:
  ...
  "route": "pde_theta_1d"
      ...
      - `route_family`: pde_solver
      - `route_name`: pde_theta_1d
  - **instruction_lifecycle** `executor_build_20260329034222_a1833952:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329034222_a1833952:decomposition`
  ...
  - **assembly** `executor_build_20260329034222_a1833952:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.pde.theta_method"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329034222_a1833952:validation`
  ...
  - **output** `executor_build_20260329034222_a1833952:output`
