# Analytical Trace: `executor_build_20260413062017_3492a7ec`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `analytical_black76`
- Model: `analytical`
- Status: `warning`
- Created at: `2026-04-13T06:20:18.344450+00:00`
- Updated at: `2026-04-13T06:20:18.398819+00:00`
- Task ID: `executor_build_20260413062017_3492a7ec`
...
## Steps
- **trace** `executor_build_20260413062017_3492a7ec:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260413062017_3492a7ec
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "analytical",
  "name": "analytical_black76"
    ...
    - `status`: warning
  - **semantic_resolution** `executor_build_20260413062017_3492a7ec:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260413062017_3492a7ec:root`
    - Notes:
  ...
  "route": "analytical_black76"
      ...
      - `route_family`: analytical
      - `route_name`: analytical_black76
  - **instruction_lifecycle** `executor_build_20260413062017_3492a7ec:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260413062017_3492a7ec:decomposition`
  ...
  - **assembly** `executor_build_20260413062017_3492a7ec:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters when the compiler found an exact backend; otherwise build the smallest lane-consistent kernel the plan requires.
  ...
  "trellis.models.rate_style_swaption"
      ...
      - `route_helper`: trellis.models.rate_style_swaption.price_swaption_black76
  - **validation** `executor_build_20260413062017_3492a7ec:validation`
  ...
  - **output** `executor_build_20260413062017_3492a7ec:output`
