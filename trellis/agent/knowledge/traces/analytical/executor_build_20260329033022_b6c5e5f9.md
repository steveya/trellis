# Analytical Trace: `executor_build_20260329033022_b6c5e5f9`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `analytical_black76`
- Model: `analytical`
- Status: `ok`
- Created at: `2026-03-29T03:30:24.383233+00:00`
- Updated at: `2026-03-29T03:30:24.537420+00:00`
- Task ID: `executor_build_20260329033022_b6c5e5f9`
...
## Steps
- **trace** `executor_build_20260329033022_b6c5e5f9:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329033022_b6c5e5f9
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "analytical",
  "name": "analytical_black76"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260329033022_b6c5e5f9:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329033022_b6c5e5f9:root`
    - Notes:
  ...
  "route": "analytical_black76"
      ...
      - `route_family`: analytical
      - `route_name`: analytical_black76
  - **instruction_lifecycle** `executor_build_20260329033022_b6c5e5f9:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329033022_b6c5e5f9:decomposition`
  ...
  - **assembly** `executor_build_20260329033022_b6c5e5f9:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.core.date_utils"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329033022_b6c5e5f9:validation`
  ...
  - **output** `executor_build_20260329033022_b6c5e5f9:output`
