# Analytical Trace: `executor_build_20260328184555_d6eecfc3`
- Trace type: `analytical`
- Route family: `monte_carlo`
- Route name: `correlated_gbm_monte_carlo`
- Model: `unknown`
- Status: `ok`
- Created at: `2026-03-28T18:45:56.071768+00:00`
- Updated at: `2026-03-28T18:45:56.216089+00:00`
- Task ID: `executor_build_20260328184555_d6eecfc3`
...
## Steps
- **trace** `executor_build_20260328184555_d6eecfc3:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260328184555_d6eecfc3
  - Outputs:
    - `route`: {
  "family": "monte_carlo",
  "model": "unknown",
  "name": "correlated_gbm_monte_carlo"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260328184555_d6eecfc3:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260328184555_d6eecfc3:root`
    - Notes:
  ...
  "Payoff"
    ...
    - Outputs:
      ...
      - `route_family`: monte_carlo
      - `route_name`: correlated_gbm_monte_carlo
  - **decomposition** `executor_build_20260328184555_d6eecfc3:decomposition`
  ...
  - **assembly** `executor_build_20260328184555_d6eecfc3:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.monte_carlo.quanto"
      ...
      - `route_helper`: trellis.models.monte_carlo.quanto.price_quanto_option_monte_carlo
  - **validation** `executor_build_20260328184555_d6eecfc3:validation`
  ...
  - **output** `executor_build_20260328184555_d6eecfc3:output`
