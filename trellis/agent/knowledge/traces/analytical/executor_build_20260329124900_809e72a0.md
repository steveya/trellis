# Analytical Trace: `executor_build_20260329124900_809e72a0`
- Trace type: `analytical`
- Route family: `pde_solver`
- Route name: `pde_theta_1d`
- Model: `pde_solver`
- Status: `warning`
- Created at: `2026-03-29T12:50:00.020063+00:00`
- Updated at: `2026-03-29T12:50:00.181903+00:00`
- Task ID: `executor_build_20260329124900_809e72a0`

## Context
- `class_name`: 'CnStandardPayoff'
...
- `spec_name`: 'CnStandardPayoffSpec'

## Steps
- **trace** `executor_build_20260329124900_809e72a0:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329124900_809e72a0
  - Outputs:
    - `route`: {
  "family": "pde_solver",
  "model": "pde_solver",
  "name": "pde_theta_1d"
    ...
    - `status`: warning
  - **semantic_resolution** `executor_build_20260329124900_809e72a0:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329124900_809e72a0:root`
    - Notes:
  ...
  "route": "pde_theta_1d"
      ...
      - `route_family`: pde_solver
      - `route_name`: pde_theta_1d
  - **instruction_lifecycle** `executor_build_20260329124900_809e72a0:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329124900_809e72a0:decomposition`
  ...
  - **assembly** `executor_build_20260329124900_809e72a0:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.pde.theta_method"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329124900_809e72a0:validation`
  ...
  - **output** `executor_build_20260329124900_809e72a0:output`
