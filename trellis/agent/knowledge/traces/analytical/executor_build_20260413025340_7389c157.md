# Analytical Trace: `executor_build_20260413025340_7389c157`
- Trace type: `analytical`
- Route family: `exercise`
- Route name: `exercise_monte_carlo`
- Model: `exercise`
- Status: `ok`
- Created at: `2026-04-13T02:53:41.668142+00:00`
- Updated at: `2026-04-13T02:53:41.702468+00:00`
- Task ID: `executor_build_20260413025340_7389c157`
...
## Steps
- **trace** `executor_build_20260413025340_7389c157:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260413025340_7389c157
  - Outputs:
    - `route`: {
  "family": "exercise",
  "model": "exercise",
  "name": "exercise_monte_carlo"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260413025340_7389c157:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260413025340_7389c157:root`
    - Notes:
  ...
  "route": "exercise_monte_carlo"
      ...
      - `route_family`: exercise
      - `route_name`: exercise_monte_carlo
  - **instruction_lifecycle** `executor_build_20260413025340_7389c157:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260413025340_7389c157:decomposition`
  ...
  - **assembly** `executor_build_20260413025340_7389c157:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters when the compiler found an exact backend; otherwise build the smallest lane-consistent kernel the plan requires.
  ...
  "trellis.models.monte_carlo.stochastic_mesh"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260413025340_7389c157:validation`
  ...
  - **output** `executor_build_20260413025340_7389c157:output`
