# Analytical Trace: `executor_build_20260329132846_ba93a04d`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `analytical_black76`
- Model: `analytical`
- Status: `ok`
- Created at: `2026-03-29T13:29:12.890400+00:00`
- Updated at: `2026-03-29T13:29:13.011758+00:00`
- Task ID: `executor_build_20260329132846_ba93a04d`
...
## Steps
- **trace** `executor_build_20260329132846_ba93a04d:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329132846_ba93a04d
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "analytical",
  "name": "analytical_black76"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260329132846_ba93a04d:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329132846_ba93a04d:root`
    - Notes:
  ...
  "route": "analytical_black76"
      ...
      - `route_family`: analytical
      - `route_name`: analytical_black76
  - **instruction_lifecycle** `executor_build_20260329132846_ba93a04d:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329132846_ba93a04d:decomposition`
  ...
  - **assembly** `executor_build_20260329132846_ba93a04d:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.core.date_utils"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329132846_ba93a04d:validation`
  ...
  - **output** `executor_build_20260329132846_ba93a04d:output`
