# Analytical Trace: `executor_build_20260328164827_290a9351`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `analytical_garman_kohlhagen`
- Model: `analytical`
- Status: `ok`
- Created at: `2026-03-28T16:48:28.142406+00:00`
- Updated at: `2026-03-28T16:48:28.280560+00:00`
- Task ID: `executor_build_20260328164827_290a9351`
...
## Steps
- **trace** `executor_build_20260328164827_290a9351:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260328164827_290a9351
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "analytical",
  "name": "analytical_garman_kohlhagen"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260328164827_290a9351:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260328164827_290a9351:root`
    - Notes:
  ...
  "exchange_option_effective_vol"
    ...
    - Outputs:
      ...
      - `route_family`: analytical
      - `route_name`: analytical_garman_kohlhagen
  - **decomposition** `executor_build_20260328164827_290a9351:decomposition`
  ...
  - **assembly** `executor_build_20260328164827_290a9351:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.core.date_utils"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260328164827_290a9351:validation`
  ...
  - **output** `executor_build_20260328164827_290a9351:output`
