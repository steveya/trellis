# Analytical Trace: `executor_build_20260413025315_522474f8`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `analytical_black76`
- Model: `analytical`
- Status: `warning`
- Created at: `2026-04-13T02:53:16.440455+00:00`
- Updated at: `2026-04-13T02:53:16.483604+00:00`
- Task ID: `executor_build_20260413025315_522474f8`
...
## Steps
- **trace** `executor_build_20260413025315_522474f8:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260413025315_522474f8
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "analytical",
  "name": "analytical_black76"
    ...
    - `status`: warning
  - **semantic_resolution** `executor_build_20260413025315_522474f8:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260413025315_522474f8:root`
    - Notes:
  ...
  "route": "analytical_black76"
      ...
      - `route_family`: analytical
      - `route_name`: analytical_black76
  - **instruction_lifecycle** `executor_build_20260413025315_522474f8:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260413025315_522474f8:decomposition`
  ...
  - **assembly** `executor_build_20260413025315_522474f8:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters when the compiler found an exact backend; otherwise build the smallest lane-consistent kernel the plan requires.
  ...
  "trellis.models.rate_style_swaption"
      ...
      - `route_helper`: trellis.models.rate_style_swaption.price_swaption_black76
  - **validation** `executor_build_20260413025315_522474f8:validation`
  ...
  - **output** `executor_build_20260413025315_522474f8:output`
