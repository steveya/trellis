# Analytical Trace: `executor_build_20260329043306_bd22d607`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `analytical_black76`
- Model: `analytical`
- Status: `ok`
- Created at: `2026-03-29T04:33:07.725939+00:00`
- Updated at: `2026-03-29T04:33:07.842422+00:00`
- Task ID: `executor_build_20260329043306_bd22d607`
...
## Steps
- **trace** `executor_build_20260329043306_bd22d607:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329043306_bd22d607
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "analytical",
  "name": "analytical_black76"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260329043306_bd22d607:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329043306_bd22d607:root`
    - Notes:
  ...
  "route": "analytical_black76"
      ...
      - `route_family`: analytical
      - `route_name`: analytical_black76
  - **instruction_lifecycle** `executor_build_20260329043306_bd22d607:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329043306_bd22d607:decomposition`
  ...
  - **assembly** `executor_build_20260329043306_bd22d607:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.core.date_utils"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329043306_bd22d607:validation`
  ...
  - **output** `executor_build_20260329043306_bd22d607:output`
