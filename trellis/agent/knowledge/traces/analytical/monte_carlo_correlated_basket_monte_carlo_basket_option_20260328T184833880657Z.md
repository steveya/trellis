# Analytical Trace: `monte_carlo_correlated_basket_monte_carlo_basket_option_20260328T184833880657Z`
- Trace type: `analytical`
- Route family: `monte_carlo`
- Route name: `correlated_basket_monte_carlo`
- Model: `monte_carlo`
- Status: `ok`
- Created at: `2026-03-28T18:48:33.880715+00:00`
- Updated at: `2026-03-28T18:48:34.013904+00:00`

## Context
- `class_name`: 'HimalayaBasketPricer'
...
## Steps
- **trace** `monte_carlo_correlated_basket_monte_carlo_basket_option_20260328T184833880657Z:root`
  ...
  "name": "correlated_basket_monte_carlo"
    ...
    - `status`: ok
  - **semantic_resolution** `monte_carlo_correlated_basket_monte_carlo_basket_option_20260328T184833880657Z:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `monte_carlo_correlated_basket_monte_carlo_basket_option_20260328T184833880657Z:root`
    - Notes:
  ...
  "PathEventSpec"
    ...
    - Outputs:
      ...
      - `route_family`: monte_carlo
      - `route_name`: correlated_basket_monte_carlo
  - **decomposition** `monte_carlo_correlated_basket_monte_carlo_basket_option_20260328T184833880657Z:decomposition`
  ...
  - **assembly** `monte_carlo_correlated_basket_monte_carlo_basket_option_20260328T184833880657Z:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.monte_carlo.semantic_basket"
      ...
      - `route_helper`: trellis.models.monte_carlo.semantic_basket.price_ranked_observation_basket_monte_carlo
  - **validation** `monte_carlo_correlated_basket_monte_carlo_basket_option_20260328T184833880657Z:validation`
  ...
  - **output** `monte_carlo_correlated_basket_monte_carlo_basket_option_20260328T184833880657Z:output`
