# Analytical Trace: `executor_build_20260328154017_2750136c`
- Trace type: `analytical`
- Route family: `monte_carlo`
- Route name: `exercise_monte_carlo`
- Model: `exercise`
- Status: `ok`
- Created at: `2026-03-28T15:40:18.413557+00:00`
- Updated at: `2026-03-28T15:40:18.565551+00:00`
- Task ID: `executor_build_20260328154017_2750136c`
...
## Steps
- **trace** `executor_build_20260328154017_2750136c:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260328154017_2750136c
  - Outputs:
    - `route`: {
  "family": "monte_carlo",
  "model": "exercise",
  "name": "exercise_monte_carlo"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260328154017_2750136c:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260328154017_2750136c:root`
    - Notes:
  ...
  "Payoff"
    ...
    - Outputs:
      ...
      - `route_family`: monte_carlo
      - `route_name`: exercise_monte_carlo
  - **decomposition** `executor_build_20260328154017_2750136c:decomposition`
  ...
  - **assembly** `executor_build_20260328154017_2750136c:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.monte_carlo.stochastic_mesh"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260328154017_2750136c:validation`
  ...
  - **output** `executor_build_20260328154017_2750136c:output`
