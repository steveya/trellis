# Analytical Trace: `executor_build_20260328184335_40f2de4e`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `analytical_black76`
- Model: `analytical`
- Status: `warning`
- Created at: `2026-03-28T18:43:35.811005+00:00`
- Updated at: `2026-03-28T18:43:35.972089+00:00`
- Task ID: `executor_build_20260328184335_40f2de4e`
...
## Steps
- **trace** `executor_build_20260328184335_40f2de4e:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260328184335_40f2de4e
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "analytical",
  "name": "analytical_black76"
    ...
    - `status`: warning
  - **semantic_resolution** `executor_build_20260328184335_40f2de4e:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260328184335_40f2de4e:root`
    - Notes:
  ...
  "instrument_type_not_provided"
    ...
    - Outputs:
      ...
      - `route_family`: analytical
      - `route_name`: analytical_black76
  - **decomposition** `executor_build_20260328184335_40f2de4e:decomposition`
  ...
  - **assembly** `executor_build_20260328184335_40f2de4e:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.core.date_utils"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260328184335_40f2de4e:validation`
  ...
  - **output** `executor_build_20260328184335_40f2de4e:output`
