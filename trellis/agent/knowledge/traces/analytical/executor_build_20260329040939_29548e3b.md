# Analytical Trace: `executor_build_20260329040939_29548e3b`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `analytical_black76`
- Model: `analytical`
- Status: `ok`
- Created at: `2026-03-29T04:09:40.899117+00:00`
- Updated at: `2026-03-29T04:09:41.059709+00:00`
- Task ID: `executor_build_20260329040939_29548e3b`
...
## Steps
- **trace** `executor_build_20260329040939_29548e3b:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329040939_29548e3b
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "analytical",
  "name": "analytical_black76"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260329040939_29548e3b:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329040939_29548e3b:root`
    - Notes:
  ...
  "route": "analytical_black76"
      ...
      - `route_family`: analytical
      - `route_name`: analytical_black76
  - **instruction_lifecycle** `executor_build_20260329040939_29548e3b:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329040939_29548e3b:decomposition`
  ...
  - **assembly** `executor_build_20260329040939_29548e3b:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.core.date_utils"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329040939_29548e3b:validation`
  ...
  - **output** `executor_build_20260329040939_29548e3b:output`
