# Analytical Trace: `executor_build_20260329163805_8afbc3c2`
- Trace type: `analytical`
- Route family: `monte_carlo`
- Route name: `monte_carlo_paths`
- Model: `monte_carlo`
- Status: `ok`
- Created at: `2026-03-29T16:38:58.829117+00:00`
- Updated at: `2026-03-29T16:38:58.952470+00:00`
- Task ID: `executor_build_20260329163805_8afbc3c2`
...
## Steps
- **trace** `executor_build_20260329163805_8afbc3c2:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329163805_8afbc3c2
  - Outputs:
    - `route`: {
  "family": "monte_carlo",
  "model": "monte_carlo",
  "name": "monte_carlo_paths"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260329163805_8afbc3c2:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329163805_8afbc3c2:root`
    - Notes:
  ...
  "route": "monte_carlo_paths"
      ...
      - `route_family`: monte_carlo
      - `route_name`: monte_carlo_paths
  - **instruction_lifecycle** `executor_build_20260329163805_8afbc3c2:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329163805_8afbc3c2:decomposition`
  ...
  - **assembly** `executor_build_20260329163805_8afbc3c2:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.monte_carlo.engine"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329163805_8afbc3c2:validation`
  ...
  - **output** `executor_build_20260329163805_8afbc3c2:output`
