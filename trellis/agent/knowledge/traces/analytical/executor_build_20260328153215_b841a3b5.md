...
## Steps
- **trace** `executor_build_20260328153215_b841a3b5:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260328153215_b841a3b5
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "analytical",
  "name": "analytical_black76"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260328153215_b841a3b5:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260328153215_b841a3b5:root`
    - Notes:
  ...
  "exchange_option_effective_vol"
    ...
    - Outputs:
      ...
      - `route_family`: analytical
      - `route_name`: analytical_black76
  - **decomposition** `executor_build_20260328153215_b841a3b5:decomposition`
  ...
  - **assembly** `executor_build_20260328153215_b841a3b5:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.core.date_utils"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260328153215_b841a3b5:validation`
  ...
  - **output** `executor_build_20260328153215_b841a3b5:output`
