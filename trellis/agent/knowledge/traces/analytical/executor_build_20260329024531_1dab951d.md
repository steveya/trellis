# Analytical Trace: `executor_build_20260329024531_1dab951d`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `analytical_black76`
- Model: `analytical`
- Status: `ok`
- Created at: `2026-03-29T02:45:32.242626+00:00`
- Updated at: `2026-03-29T02:45:32.404821+00:00`
- Task ID: `executor_build_20260329024531_1dab951d`
...
## Steps
- **trace** `executor_build_20260329024531_1dab951d:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329024531_1dab951d
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "analytical",
  "name": "analytical_black76"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260329024531_1dab951d:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329024531_1dab951d:root`
    - Notes:
  ...
  "route": "analytical_black76"
      ...
      - `route_family`: analytical
      - `route_name`: analytical_black76
  - **instruction_lifecycle** `executor_build_20260329024531_1dab951d:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329024531_1dab951d:decomposition`
  ...
  - **assembly** `executor_build_20260329024531_1dab951d:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.core.date_utils"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329024531_1dab951d:validation`
  ...
  - **output** `executor_build_20260329024531_1dab951d:output`
