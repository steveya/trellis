# Analytical Trace: `executor_build_20260329123632_adfdf417`
- Trace type: `analytical`
- Route family: `pde_solver`
- Route name: `pde_theta_1d`
- Model: `pde_solver`
- Status: `ok`
- Created at: `2026-03-29T12:36:54.894444+00:00`
- Updated at: `2026-03-29T12:36:55.055783+00:00`
- Task ID: `executor_build_20260329123632_adfdf417`

## Context
- `class_name`: 'LogGridPdePricer'
...
- `spec_name`: 'LogGridPdeSpec'

## Steps
- **trace** `executor_build_20260329123632_adfdf417:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329123632_adfdf417
  - Outputs:
    - `route`: {
  "family": "pde_solver",
  "model": "pde_solver",
  "name": "pde_theta_1d"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260329123632_adfdf417:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329123632_adfdf417:root`
    - Notes:
  ...
  "route": "pde_theta_1d"
      ...
      - `route_family`: pde_solver
      - `route_name`: pde_theta_1d
  - **instruction_lifecycle** `executor_build_20260329123632_adfdf417:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329123632_adfdf417:decomposition`
  ...
  - **assembly** `executor_build_20260329123632_adfdf417:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.pde.theta_method"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329123632_adfdf417:validation`
  ...
  - **output** `executor_build_20260329123632_adfdf417:output`
