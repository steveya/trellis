...
## Steps
- **trace** `executor_build_20260328154034_9de1fce2:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260328154034_9de1fce2
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "analytical",
  "name": "analytical_black76"
    ...
    - `status`: warning
  - **semantic_resolution** `executor_build_20260328154034_9de1fce2:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260328154034_9de1fce2:root`
    - Notes:
  ...
  "instrument_type_not_provided"
    ...
    - Outputs:
      ...
      - `route_family`: analytical
      - `route_name`: analytical_black76
  - **decomposition** `executor_build_20260328154034_9de1fce2:decomposition`
  ...
  - **assembly** `executor_build_20260328154034_9de1fce2:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.core.date_utils"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260328154034_9de1fce2:validation`
  ...
  - **output** `executor_build_20260328154034_9de1fce2:output`
