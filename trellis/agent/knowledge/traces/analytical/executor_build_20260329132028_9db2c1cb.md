...
## Steps
- **trace** `executor_build_20260329132028_9db2c1cb:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329132028_9db2c1cb
  - Outputs:
    - `route`: {
  "family": "monte_carlo",
  "model": "exercise",
  "name": "exercise_monte_carlo"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260329132028_9db2c1cb:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329132028_9db2c1cb:root`
    - Notes:
  ...
  "route": "exercise_monte_carlo"
      ...
      - `route_family`: monte_carlo
      - `route_name`: exercise_monte_carlo
  - **instruction_lifecycle** `executor_build_20260329132028_9db2c1cb:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329132028_9db2c1cb:decomposition`
  ...
  - **assembly** `executor_build_20260329132028_9db2c1cb:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.monte_carlo.stochastic_mesh"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329132028_9db2c1cb:validation`
  ...
  - **output** `executor_build_20260329132028_9db2c1cb:output`
