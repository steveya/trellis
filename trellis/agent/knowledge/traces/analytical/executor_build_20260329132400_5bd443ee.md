# Analytical Trace: `executor_build_20260329132400_5bd443ee`
- Trace type: `analytical`
- Route family: `monte_carlo`
- Route name: `monte_carlo_paths`
- Model: `monte_carlo`
- Status: `ok`
- Created at: `2026-03-29T13:24:30.849580+00:00`
- Updated at: `2026-03-29T13:24:30.976597+00:00`
- Task ID: `executor_build_20260329132400_5bd443ee`
...
## Steps
- **trace** `executor_build_20260329132400_5bd443ee:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329132400_5bd443ee
  - Outputs:
    - `route`: {
  "family": "monte_carlo",
  "model": "monte_carlo",
  "name": "monte_carlo_paths"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260329132400_5bd443ee:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329132400_5bd443ee:root`
    - Notes:
  ...
  "route": "monte_carlo_paths"
      ...
      - `route_family`: monte_carlo
      - `route_name`: monte_carlo_paths
  - **instruction_lifecycle** `executor_build_20260329132400_5bd443ee:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329132400_5bd443ee:decomposition`
  ...
  - **assembly** `executor_build_20260329132400_5bd443ee:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.monte_carlo.engine"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329132400_5bd443ee:validation`
  ...
  - **output** `executor_build_20260329132400_5bd443ee:output`
