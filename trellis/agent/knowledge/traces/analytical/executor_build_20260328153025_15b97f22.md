# Analytical Trace: `executor_build_20260328153025_15b97f22`
- Trace type: `analytical`
- Route family: `monte_carlo`
- Route name: `monte_carlo_paths`
- Model: `monte_carlo`
- Status: `ok`
- Created at: `2026-03-28T15:30:25.811244+00:00`
- Updated at: `2026-03-28T15:30:25.965253+00:00`
- Task ID: `executor_build_20260328153025_15b97f22`
...
## Steps
- **trace** `executor_build_20260328153025_15b97f22:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260328153025_15b97f22
  - Outputs:
    - `route`: {
  "family": "monte_carlo",
  "model": "monte_carlo",
  "name": "monte_carlo_paths"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260328153025_15b97f22:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260328153025_15b97f22:root`
    - Notes:
  ...
  "Payoff"
    ...
    - Outputs:
      ...
      - `route_family`: monte_carlo
      - `route_name`: monte_carlo_paths
  - **decomposition** `executor_build_20260328153025_15b97f22:decomposition`
  ...
  - **assembly** `executor_build_20260328153025_15b97f22:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.monte_carlo.engine"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260328153025_15b97f22:validation`
  ...
  - **output** `executor_build_20260328153025_15b97f22:output`
