# Analytical Trace: `analytical_analytical_black76_basket_option_20260328T163809669994Z`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `analytical_black76`
- Model: `analytical`
- Status: `warning`
- Created at: `2026-03-28T16:38:09.670037+00:00`
- Updated at: `2026-03-28T16:38:09.815006+00:00`

## Context
- `class_name`: 'HimalayaRankedObservationBasket'
...
- `spec_name`: 'HimalayaRankedObservationBasketSpec'

## Steps
- **trace** `analytical_analytical_black76_basket_option_20260328T163809669994Z:root`
  ...
  "name": "analytical_black76"
    ...
    - `status`: warning
  - **semantic_resolution** `analytical_analytical_black76_basket_option_20260328T163809669994Z:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `analytical_analytical_black76_basket_option_20260328T163809669994Z:root`
    - Notes:
  ...
  "quant_plan_has_no_explicit_method_modules"
    ...
    - Outputs:
      ...
      - `route_family`: analytical
      - `route_name`: analytical_black76
  - **decomposition** `analytical_analytical_black76_basket_option_20260328T163809669994Z:decomposition`
  ...
  - **assembly** `analytical_analytical_black76_basket_option_20260328T163809669994Z:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.core.date_utils"
      ...
      - `route_helper`: None
  - **validation** `analytical_analytical_black76_basket_option_20260328T163809669994Z:validation`
  ...
  - **output** `analytical_analytical_black76_basket_option_20260328T163809669994Z:output`
