# Analytical Trace: `executor_build_20260413025343_ee4305ba`
- Trace type: `analytical`
- Route family: `rate_lattice`
- Route name: `exercise_lattice`
- Model: `lattice`
- Status: `ok`
- Created at: `2026-04-13T02:53:43.918684+00:00`
- Updated at: `2026-04-13T02:53:43.964519+00:00`
- Task ID: `executor_build_20260413025343_ee4305ba`
...
## Steps
- **trace** `executor_build_20260413025343_ee4305ba:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260413025343_ee4305ba
  - Outputs:
    - `route`: {
  "family": "rate_lattice",
  "model": "lattice",
  "name": "exercise_lattice"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260413025343_ee4305ba:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260413025343_ee4305ba:root`
    - Notes:
  ...
  "route": "exercise_lattice"
      ...
      - `route_family`: rate_lattice
      - `route_name`: exercise_lattice
  - **instruction_lifecycle** `executor_build_20260413025343_ee4305ba:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260413025343_ee4305ba:decomposition`
  ...
  - **assembly** `executor_build_20260413025343_ee4305ba:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters when the compiler found an exact backend; otherwise build the smallest lane-consistent kernel the plan requires.
  ...
  "trellis.models.bermudan_swaption_tree"
      ...
      - `route_helper`: trellis.models.bermudan_swaption_tree.price_bermudan_swaption_tree
  - **validation** `executor_build_20260413025343_ee4305ba:validation`
  ...
  - **output** `executor_build_20260413025343_ee4305ba:output`
