# Analytical Trace: `executor_build_20260328184433_de6f3fed`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `analytical_black76`
- Model: `analytical`
- Status: `warning`
- Created at: `2026-03-28T18:44:33.206725+00:00`
- Updated at: `2026-03-28T18:44:33.367679+00:00`
- Task ID: `executor_build_20260328184433_de6f3fed`
...
## Steps
- **trace** `executor_build_20260328184433_de6f3fed:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260328184433_de6f3fed
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "analytical",
  "name": "analytical_black76"
    ...
    - `status`: warning
  - **semantic_resolution** `executor_build_20260328184433_de6f3fed:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260328184433_de6f3fed:root`
    - Notes:
  ...
  "instrument_type_not_provided"
    ...
    - Outputs:
      ...
      - `route_family`: analytical
      - `route_name`: analytical_black76
  - **decomposition** `executor_build_20260328184433_de6f3fed:decomposition`
  ...
  - **assembly** `executor_build_20260328184433_de6f3fed:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.core.date_utils"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260328184433_de6f3fed:validation`
  ...
  - **output** `executor_build_20260328184433_de6f3fed:output`
