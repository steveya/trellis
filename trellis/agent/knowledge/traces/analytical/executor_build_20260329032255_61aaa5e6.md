...
- `spec_name`: 'GBMCallSpec'

## Steps
- **trace** `executor_build_20260329032255_61aaa5e6:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329032255_61aaa5e6
  - Outputs:
    - `route`: {
  "family": "monte_carlo",
  "model": "monte_carlo",
  "name": "monte_carlo_paths"
    ...
    - `status`: warning
  - **semantic_resolution** `executor_build_20260329032255_61aaa5e6:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329032255_61aaa5e6:root`
    - Notes:
  ...
  "route": "monte_carlo_paths"
      ...
      - `route_family`: monte_carlo
      - `route_name`: monte_carlo_paths
  - **instruction_lifecycle** `executor_build_20260329032255_61aaa5e6:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329032255_61aaa5e6:decomposition`
  ...
  - **assembly** `executor_build_20260329032255_61aaa5e6:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.monte_carlo.engine"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329032255_61aaa5e6:validation`
  ...
  - **output** `executor_build_20260329032255_61aaa5e6:output`
