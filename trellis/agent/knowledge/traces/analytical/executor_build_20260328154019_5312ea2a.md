# Analytical Trace: `executor_build_20260328154019_5312ea2a`
- Trace type: `analytical`
- Route family: `monte_carlo`
- Route name: `exercise_monte_carlo`
- Model: `exercise`
- Status: `warning`
- Created at: `2026-03-28T15:40:19.718140+00:00`
- Updated at: `2026-03-28T15:40:19.878370+00:00`
- Task ID: `executor_build_20260328154019_5312ea2a`
...
## Steps
- **trace** `executor_build_20260328154019_5312ea2a:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260328154019_5312ea2a
  - Outputs:
    - `route`: {
  "family": "monte_carlo",
  "model": "exercise",
  "name": "exercise_monte_carlo"
    ...
    - `status`: warning
  - **semantic_resolution** `executor_build_20260328154019_5312ea2a:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260328154019_5312ea2a:root`
    - Notes:
  ...
  "primitive_plan_has_blockers"
    ...
    - Outputs:
      ...
      - `route_family`: monte_carlo
      - `route_name`: exercise_monte_carlo
  - **decomposition** `executor_build_20260328154019_5312ea2a:decomposition`
  ...
  - **assembly** `executor_build_20260328154019_5312ea2a:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.monte_carlo.stochastic_mesh"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260328154019_5312ea2a:validation`
  ...
  - **output** `executor_build_20260328154019_5312ea2a:output`
