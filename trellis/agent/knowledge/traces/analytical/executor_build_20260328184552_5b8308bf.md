# Analytical Trace: `executor_build_20260328184552_5b8308bf`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `analytical_garman_kohlhagen`
- Model: `analytical`
- Status: `ok`
- Created at: `2026-03-28T18:45:52.947909+00:00`
- Updated at: `2026-03-28T18:45:53.113662+00:00`
- Task ID: `executor_build_20260328184552_5b8308bf`
...
## Steps
- **trace** `executor_build_20260328184552_5b8308bf:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260328184552_5b8308bf
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "analytical",
  "name": "analytical_garman_kohlhagen"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260328184552_5b8308bf:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260328184552_5b8308bf:root`
    - Notes:
  ...
  "exchange_option_effective_vol"
    ...
    - Outputs:
      ...
      - `route_family`: analytical
      - `route_name`: analytical_garman_kohlhagen
  - **decomposition** `executor_build_20260328184552_5b8308bf:decomposition`
  ...
  - **assembly** `executor_build_20260328184552_5b8308bf:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.core.date_utils"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260328184552_5b8308bf:validation`
  ...
  - **output** `executor_build_20260328184552_5b8308bf:output`
