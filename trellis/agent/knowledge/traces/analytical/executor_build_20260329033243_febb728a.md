# Analytical Trace: `executor_build_20260329033243_febb728a`
- Trace type: `analytical`
- Route family: `pde_solver`
- Route name: `pde_theta_1d`
- Model: `pde_solver`
- Status: `ok`
- Created at: `2026-03-29T03:32:44.275264+00:00`
- Updated at: `2026-03-29T03:32:44.429541+00:00`
- Task ID: `executor_build_20260329033243_febb728a`
...
## Steps
- **trace** `executor_build_20260329033243_febb728a:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329033243_febb728a
  - Outputs:
    - `route`: {
  "family": "pde_solver",
  "model": "pde_solver",
  "name": "pde_theta_1d"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260329033243_febb728a:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329033243_febb728a:root`
    - Notes:
  ...
  "route": "pde_theta_1d"
      ...
      - `route_family`: pde_solver
      - `route_name`: pde_theta_1d
  - **instruction_lifecycle** `executor_build_20260329033243_febb728a:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329033243_febb728a:decomposition`
  ...
  - **assembly** `executor_build_20260329033243_febb728a:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.pde.theta_method"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329033243_febb728a:validation`
  ...
  - **output** `executor_build_20260329033243_febb728a:output`
