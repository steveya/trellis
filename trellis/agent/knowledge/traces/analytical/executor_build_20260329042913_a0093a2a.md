# Analytical Trace: `executor_build_20260329042913_a0093a2a`
- Trace type: `analytical`
- Route family: `pde_solver`
- Route name: `pde_theta_1d`
- Model: `pde_solver`
- Status: `ok`
- Created at: `2026-03-29T04:29:13.960578+00:00`
- Updated at: `2026-03-29T04:29:14.078699+00:00`
- Task ID: `executor_build_20260329042913_a0093a2a`
...
## Steps
- **trace** `executor_build_20260329042913_a0093a2a:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329042913_a0093a2a
  - Outputs:
    - `route`: {
  "family": "pde_solver",
  "model": "pde_solver",
  "name": "pde_theta_1d"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260329042913_a0093a2a:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329042913_a0093a2a:root`
    - Notes:
  ...
  "route": "pde_theta_1d"
      ...
      - `route_family`: pde_solver
      - `route_name`: pde_theta_1d
  - **instruction_lifecycle** `executor_build_20260329042913_a0093a2a:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329042913_a0093a2a:decomposition`
  ...
  - **assembly** `executor_build_20260329042913_a0093a2a:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.pde.theta_method"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329042913_a0093a2a:validation`
  ...
  - **output** `executor_build_20260329042913_a0093a2a:output`
