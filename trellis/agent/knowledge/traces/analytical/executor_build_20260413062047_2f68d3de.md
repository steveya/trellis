...
- **trace** `executor_build_20260413062047_2f68d3de:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260413062047_2f68d3de
  - Outputs:
    - `route`: {
  "family": "exercise",
  "model": "exercise",
  "name": "exercise_monte_carlo"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260413062047_2f68d3de:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260413062047_2f68d3de:root`
    - Notes:
  ...
  "route": "exercise_monte_carlo"
      ...
      - `route_family`: exercise
      - `route_name`: exercise_monte_carlo
  - **instruction_lifecycle** `executor_build_20260413062047_2f68d3de:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260413062047_2f68d3de:decomposition`
  ...
  - **assembly** `executor_build_20260413062047_2f68d3de:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters when the compiler found an exact backend; otherwise build the smallest lane-consistent kernel the plan requires.
  ...
  "trellis.models.monte_carlo.stochastic_mesh"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260413062047_2f68d3de:validation`
  ...
  - **output** `executor_build_20260413062047_2f68d3de:output`
