# Analytical Trace: `executor_build_20260329123352_81f605e2`
- Trace type: `analytical`
- Route family: `monte_carlo`
- Route name: `monte_carlo_paths`
- Model: `monte_carlo`
- Status: `ok`
- Created at: `2026-03-29T12:34:17.896013+00:00`
- Updated at: `2026-03-29T12:34:18.050355+00:00`
- Task ID: `executor_build_20260329123352_81f605e2`
...
## Steps
- **trace** `executor_build_20260329123352_81f605e2:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329123352_81f605e2
  - Outputs:
    - `route`: {
  "family": "monte_carlo",
  "model": "monte_carlo",
  "name": "monte_carlo_paths"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260329123352_81f605e2:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329123352_81f605e2:root`
    - Notes:
  ...
  "route": "monte_carlo_paths"
      ...
      - `route_family`: monte_carlo
      - `route_name`: monte_carlo_paths
  - **instruction_lifecycle** `executor_build_20260329123352_81f605e2:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329123352_81f605e2:decomposition`
  ...
  - **assembly** `executor_build_20260329123352_81f605e2:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.monte_carlo.engine"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329123352_81f605e2:validation`
  ...
  - **output** `executor_build_20260329123352_81f605e2:output`
