# Analytical Trace: `executor_build_20260413025338_97f12c7e`
- Trace type: `analytical`
- Route family: `exercise`
- Route name: `exercise_monte_carlo`
- Model: `exercise`
- Status: `ok`
- Created at: `2026-04-13T02:53:38.958994+00:00`
- Updated at: `2026-04-13T02:53:38.993584+00:00`
- Task ID: `executor_build_20260413025338_97f12c7e`
...
## Steps
- **trace** `executor_build_20260413025338_97f12c7e:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260413025338_97f12c7e
  - Outputs:
    - `route`: {
  "family": "exercise",
  "model": "exercise",
  "name": "exercise_monte_carlo"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260413025338_97f12c7e:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260413025338_97f12c7e:root`
    - Notes:
  ...
  "route": "exercise_monte_carlo"
      ...
      - `route_family`: exercise
      - `route_name`: exercise_monte_carlo
  - **instruction_lifecycle** `executor_build_20260413025338_97f12c7e:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260413025338_97f12c7e:decomposition`
  ...
  - **assembly** `executor_build_20260413025338_97f12c7e:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters when the compiler found an exact backend; otherwise build the smallest lane-consistent kernel the plan requires.
  ...
  "trellis.models.monte_carlo.stochastic_mesh"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260413025338_97f12c7e:validation`
  ...
  - **output** `executor_build_20260413025338_97f12c7e:output`
