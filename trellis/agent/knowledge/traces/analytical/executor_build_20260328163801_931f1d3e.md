# Analytical Trace: `executor_build_20260328163801_931f1d3e`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `quanto_adjustment_analytical`
- Model: `unknown`
- Status: `ok`
- Created at: `2026-03-28T16:38:01.907678+00:00`
- Updated at: `2026-03-28T16:38:02.065206+00:00`
- Task ID: `executor_build_20260328163801_931f1d3e`
...
## Steps
- **trace** `executor_build_20260328163801_931f1d3e:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260328163801_931f1d3e
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "unknown",
  "name": "quanto_adjustment_analytical"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260328163801_931f1d3e:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260328163801_931f1d3e:root`
    - Notes:
  ...
  "discount_factor_from_zero_rate"
    ...
    - Outputs:
      ...
      - `route_family`: analytical
      - `route_name`: quanto_adjustment_analytical
  - **decomposition** `executor_build_20260328163801_931f1d3e:decomposition`
  ...
  - **assembly** `executor_build_20260328163801_931f1d3e:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.analytical.quanto"
      ...
      - `route_helper`: trellis.models.analytical.quanto.price_quanto_option_analytical
  - **validation** `executor_build_20260328163801_931f1d3e:validation`
  ...
  - **output** `executor_build_20260328163801_931f1d3e:output`
