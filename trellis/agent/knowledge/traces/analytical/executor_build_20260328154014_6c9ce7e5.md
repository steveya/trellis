# Analytical Trace: `executor_build_20260328154014_6c9ce7e5`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `analytical_black76`
- Model: `analytical`
- Status: `warning`
- Created at: `2026-03-28T15:40:14.144332+00:00`
- Updated at: `2026-03-28T15:40:14.287739+00:00`
- Task ID: `executor_build_20260328154014_6c9ce7e5`
...
## Steps
- **trace** `executor_build_20260328154014_6c9ce7e5:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260328154014_6c9ce7e5
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "analytical",
  "name": "analytical_black76"
    ...
    - `status`: warning
  - **semantic_resolution** `executor_build_20260328154014_6c9ce7e5:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260328154014_6c9ce7e5:root`
    - Notes:
  ...
  "instrument_type_not_provided"
    ...
    - Outputs:
      ...
      - `route_family`: analytical
      - `route_name`: analytical_black76
  - **decomposition** `executor_build_20260328154014_6c9ce7e5:decomposition`
  ...
  - **assembly** `executor_build_20260328154014_6c9ce7e5:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.core.date_utils"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260328154014_6c9ce7e5:validation`
  ...
  - **output** `executor_build_20260328154014_6c9ce7e5:output`
