...
## Steps
- **trace** `executor_build_20260413062052_fef78155:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260413062052_fef78155
  - Outputs:
    - `route`: {
  "family": "exercise",
  "model": "exercise",
  "name": "exercise_monte_carlo"
    ...
    - `status`: warning
  - **semantic_resolution** `executor_build_20260413062052_fef78155:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260413062052_fef78155:root`
    - Notes:
  ...
  "route": "exercise_monte_carlo"
      ...
      - `route_family`: exercise
      - `route_name`: exercise_monte_carlo
  - **instruction_lifecycle** `executor_build_20260413062052_fef78155:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260413062052_fef78155:decomposition`
  ...
  - **assembly** `executor_build_20260413062052_fef78155:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters when the compiler found an exact backend; otherwise build the smallest lane-consistent kernel the plan requires.
  ...
  "trellis.models.monte_carlo.stochastic_mesh"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260413062052_fef78155:validation`
  ...
  - **output** `executor_build_20260413062052_fef78155:output`
