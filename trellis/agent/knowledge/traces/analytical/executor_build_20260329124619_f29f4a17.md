# Analytical Trace: `executor_build_20260329124619_f29f4a17`
- Trace type: `analytical`
- Route family: `pde_solver`
- Route name: `pde_theta_1d`
- Model: `pde_solver`
- Status: `warning`
- Created at: `2026-03-29T12:46:45.946596+00:00`
- Updated at: `2026-03-29T12:46:46.064306+00:00`
- Task ID: `executor_build_20260329124619_f29f4a17`

## Context
- `class_name`: 'CnRannacherPayoff'
...
- `spec_name`: 'CnRannacherSpec'

## Steps
- **trace** `executor_build_20260329124619_f29f4a17:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329124619_f29f4a17
  - Outputs:
    - `route`: {
  "family": "pde_solver",
  "model": "pde_solver",
  "name": "pde_theta_1d"
    ...
    - `status`: warning
  - **semantic_resolution** `executor_build_20260329124619_f29f4a17:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329124619_f29f4a17:root`
    - Notes:
  ...
  "route": "pde_theta_1d"
      ...
      - `route_family`: pde_solver
      - `route_name`: pde_theta_1d
  - **instruction_lifecycle** `executor_build_20260329124619_f29f4a17:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329124619_f29f4a17:decomposition`
  ...
  - **assembly** `executor_build_20260329124619_f29f4a17:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.pde.theta_method"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329124619_f29f4a17:validation`
  ...
  - **output** `executor_build_20260329124619_f29f4a17:output`
