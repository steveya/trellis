...
## Steps
- **trace** `executor_build_20260413062045_98b24612:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260413062045_98b24612
  - Outputs:
    - `route`: {
  "family": "monte_carlo",
  "model": "monte_carlo",
  "name": "correlated_gbm_monte_carlo"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260413062045_98b24612:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260413062045_98b24612:root`
    - Notes:
  ...
  "route": "correlated_gbm_monte_carlo"
      ...
      - `route_family`: monte_carlo
      - `route_name`: correlated_gbm_monte_carlo
  - **instruction_lifecycle** `executor_build_20260413062045_98b24612:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260413062045_98b24612:decomposition`
  ...
  - **assembly** `executor_build_20260413062045_98b24612:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters when the compiler found an exact backend; otherwise build the smallest lane-consistent kernel the plan requires.
  ...
  "trellis.models.quanto_option"
      ...
      - `route_helper`: trellis.models.quanto_option.price_quanto_option_monte_carlo_from_market_state
  - **validation** `executor_build_20260413062045_98b24612:validation`
  ...
  - **output** `executor_build_20260413062045_98b24612:output`
