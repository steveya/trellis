...
## Steps
- **trace** `monte_carlo_monte_carlo_paths_basket_option_20260328T160230032078Z:root`
  ...
  "name": "monte_carlo_paths"
    ...
    - `status`: ok
  - **semantic_resolution** `monte_carlo_monte_carlo_paths_basket_option_20260328T160230032078Z:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `monte_carlo_monte_carlo_paths_basket_option_20260328T160230032078Z:root`
    - Notes:
  ...
  "PathEventTimeline"
    ...
    - Outputs:
      ...
      - `route_family`: monte_carlo
      - `route_name`: monte_carlo_paths
  - **decomposition** `monte_carlo_monte_carlo_paths_basket_option_20260328T160230032078Z:decomposition`
  ...
  - **assembly** `monte_carlo_monte_carlo_paths_basket_option_20260328T160230032078Z:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.monte_carlo.engine"
      ...
      - `route_helper`: None
  - **validation** `monte_carlo_monte_carlo_paths_basket_option_20260328T160230032078Z:validation`
  ...
  - **output** `monte_carlo_monte_carlo_paths_basket_option_20260328T160230032078Z:output`
