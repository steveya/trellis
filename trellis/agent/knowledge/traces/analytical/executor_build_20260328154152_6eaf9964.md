# Analytical Trace: `executor_build_20260328154152_6eaf9964`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `analytical_black76`
- Model: `analytical`
- Status: `warning`
- Created at: `2026-03-28T15:41:52.682584+00:00`
- Updated at: `2026-03-28T15:41:52.837981+00:00`
- Task ID: `executor_build_20260328154152_6eaf9964`
...
## Steps
- **trace** `executor_build_20260328154152_6eaf9964:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260328154152_6eaf9964
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "analytical",
  "name": "analytical_black76"
    ...
    - `status`: warning
  - **semantic_resolution** `executor_build_20260328154152_6eaf9964:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260328154152_6eaf9964:root`
    - Notes:
  ...
  "instrument_type_not_provided"
    ...
    - Outputs:
      ...
      - `route_family`: analytical
      - `route_name`: analytical_black76
  - **decomposition** `executor_build_20260328154152_6eaf9964:decomposition`
  ...
  - **assembly** `executor_build_20260328154152_6eaf9964:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.core.date_utils"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260328154152_6eaf9964:validation`
  ...
  - **output** `executor_build_20260328154152_6eaf9964:output`
