# Analytical Trace: `executor_build_20260329123851_8866a8a2`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `analytical_black76`
- Model: `analytical`
- Status: `ok`
- Created at: `2026-03-29T12:39:13.728613+00:00`
- Updated at: `2026-03-29T12:39:13.846642+00:00`
- Task ID: `executor_build_20260329123851_8866a8a2`

## Context
- `class_name`: 'NonUniformLogGridBarrierPayoff'
...
- `spec_name`: 'NonUniformLogGridBarrierSpec'

## Steps
- **trace** `executor_build_20260329123851_8866a8a2:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329123851_8866a8a2
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "analytical",
  "name": "analytical_black76"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260329123851_8866a8a2:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329123851_8866a8a2:root`
    - Notes:
  ...
  "route": "analytical_black76"
      ...
      - `route_family`: analytical
      - `route_name`: analytical_black76
  - **instruction_lifecycle** `executor_build_20260329123851_8866a8a2:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329123851_8866a8a2:decomposition`
  ...
  - **assembly** `executor_build_20260329123851_8866a8a2:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.core.date_utils"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329123851_8866a8a2:validation`
  ...
  - **output** `executor_build_20260329123851_8866a8a2:output`
