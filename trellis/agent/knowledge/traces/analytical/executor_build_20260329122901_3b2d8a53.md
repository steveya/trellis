# Analytical Trace: `executor_build_20260329122901_3b2d8a53`
- Trace type: `analytical`
- Route family: `rate_tree`
- Route name: `exercise_lattice`
- Model: `lattice`
- Status: `ok`
- Created at: `2026-03-29T12:29:29.131000+00:00`
- Updated at: `2026-03-29T12:29:29.284768+00:00`
- Task ID: `executor_build_20260329122901_3b2d8a53`
...
## Steps
- **trace** `executor_build_20260329122901_3b2d8a53:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329122901_3b2d8a53
  - Outputs:
    - `route`: {
  "family": "rate_tree",
  "model": "lattice",
  "name": "exercise_lattice"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260329122901_3b2d8a53:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329122901_3b2d8a53:root`
    - Notes:
  ...
  "route": "exercise_lattice"
      ...
      - `route_family`: rate_tree
      - `route_name`: exercise_lattice
  - **instruction_lifecycle** `executor_build_20260329122901_3b2d8a53:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329122901_3b2d8a53:decomposition`
  ...
  - **assembly** `executor_build_20260329122901_3b2d8a53:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.trees.lattice"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329122901_3b2d8a53:validation`
  ...
  - **output** `executor_build_20260329122901_3b2d8a53:output`
