...
## Steps
- **trace** `executor_build_20260413062036_7e3c915c:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260413062036_7e3c915c
  - Outputs:
    - `route`: {
  "family": "monte_carlo",
  "model": "monte_carlo",
  "name": "monte_carlo_fx_vanilla"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260413062036_7e3c915c:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260413062036_7e3c915c:root`
    - Notes:
  ...
  "route": "monte_carlo_fx_vanilla"
      ...
      - `route_family`: monte_carlo
      - `route_name`: monte_carlo_fx_vanilla
  - **instruction_lifecycle** `executor_build_20260413062036_7e3c915c:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260413062036_7e3c915c:decomposition`
  ...
  - **assembly** `executor_build_20260413062036_7e3c915c:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters when the compiler found an exact backend; otherwise build the smallest lane-consistent kernel the plan requires.
  ...
  "trellis.models.fx_vanilla"
      ...
      - `route_helper`: trellis.models.fx_vanilla.price_fx_vanilla_monte_carlo
  - **validation** `executor_build_20260413062036_7e3c915c:validation`
  ...
  - **output** `executor_build_20260413062036_7e3c915c:output`
