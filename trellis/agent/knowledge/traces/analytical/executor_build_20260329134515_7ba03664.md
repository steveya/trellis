# Analytical Trace: `executor_build_20260329134515_7ba03664`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `analytical_black76`
- Model: `analytical`
- Status: `warning`
- Created at: `2026-03-29T13:45:42.657495+00:00`
- Updated at: `2026-03-29T13:45:42.827632+00:00`
- Task ID: `executor_build_20260329134515_7ba03664`

## Context
- `class_name`: 'CrankNicolsonRannacherPayoff'
...
- `spec_name`: 'CrankNicolsonRannacherSpec'

## Steps
- **trace** `executor_build_20260329134515_7ba03664:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329134515_7ba03664
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "analytical",
  "name": "analytical_black76"
    ...
    - `status`: warning
  - **semantic_resolution** `executor_build_20260329134515_7ba03664:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329134515_7ba03664:root`
    - Notes:
  ...
  "route": "analytical_black76"
      ...
      - `route_family`: analytical
      - `route_name`: analytical_black76
  - **instruction_lifecycle** `executor_build_20260329134515_7ba03664:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329134515_7ba03664:decomposition`
  ...
  - **assembly** `executor_build_20260329134515_7ba03664:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.core.date_utils"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329134515_7ba03664:validation`
  ...
  - **output** `executor_build_20260329134515_7ba03664:output`
