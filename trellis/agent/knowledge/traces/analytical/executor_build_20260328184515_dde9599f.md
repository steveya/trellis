# Analytical Trace: `executor_build_20260328184515_dde9599f`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `analytical_black76`
- Model: `analytical`
- Status: `warning`
- Created at: `2026-03-28T18:45:15.612724+00:00`
- Updated at: `2026-03-28T18:45:15.747825+00:00`
- Task ID: `executor_build_20260328184515_dde9599f`
...
## Steps
- **trace** `executor_build_20260328184515_dde9599f:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260328184515_dde9599f
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "analytical",
  "name": "analytical_black76"
    ...
    - `status`: warning
  - **semantic_resolution** `executor_build_20260328184515_dde9599f:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260328184515_dde9599f:root`
    - Notes:
  ...
  "instrument_type_not_provided"
    ...
    - Outputs:
      ...
      - `route_family`: analytical
      - `route_name`: analytical_black76
  - **decomposition** `executor_build_20260328184515_dde9599f:decomposition`
  ...
  - **assembly** `executor_build_20260328184515_dde9599f:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.core.date_utils"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260328184515_dde9599f:validation`
  ...
  - **output** `executor_build_20260328184515_dde9599f:output`
