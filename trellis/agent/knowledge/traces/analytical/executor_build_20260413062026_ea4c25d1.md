# Analytical Trace: `executor_build_20260413062026_ea4c25d1`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `quanto_adjustment_analytical`
- Model: `analytical`
- Status: `ok`
- Created at: `2026-04-13T06:20:27.531792+00:00`
- Updated at: `2026-04-13T06:20:27.587255+00:00`
- Task ID: `executor_build_20260413062026_ea4c25d1`
...
## Steps
- **trace** `executor_build_20260413062026_ea4c25d1:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260413062026_ea4c25d1
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "analytical",
  "name": "quanto_adjustment_analytical"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260413062026_ea4c25d1:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260413062026_ea4c25d1:root`
    - Notes:
  ...
  "route": "quanto_adjustment_analytical"
      ...
      - `route_family`: analytical
      - `route_name`: quanto_adjustment_analytical
  - **instruction_lifecycle** `executor_build_20260413062026_ea4c25d1:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260413062026_ea4c25d1:decomposition`
  ...
  - **assembly** `executor_build_20260413062026_ea4c25d1:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters when the compiler found an exact backend; otherwise build the smallest lane-consistent kernel the plan requires.
  ...
  "trellis.models.quanto_option"
      ...
      - `route_helper`: trellis.models.quanto_option.price_quanto_option_analytical_from_market_state
  - **validation** `executor_build_20260413062026_ea4c25d1:validation`
  ...
  - **output** `executor_build_20260413062026_ea4c25d1:output`
