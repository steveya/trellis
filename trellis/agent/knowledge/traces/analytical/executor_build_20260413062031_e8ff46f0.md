# Analytical Trace: `executor_build_20260413062031_e8ff46f0`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `quanto_adjustment_analytical`
- Model: `analytical`
- Status: `ok`
- Created at: `2026-04-13T06:20:32.664794+00:00`
- Updated at: `2026-04-13T06:20:32.717206+00:00`
- Task ID: `executor_build_20260413062031_e8ff46f0`
...
## Steps
- **trace** `executor_build_20260413062031_e8ff46f0:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260413062031_e8ff46f0
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "analytical",
  "name": "quanto_adjustment_analytical"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260413062031_e8ff46f0:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260413062031_e8ff46f0:root`
    - Notes:
  ...
  "route": "quanto_adjustment_analytical"
      ...
      - `route_family`: analytical
      - `route_name`: quanto_adjustment_analytical
  - **instruction_lifecycle** `executor_build_20260413062031_e8ff46f0:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260413062031_e8ff46f0:decomposition`
  ...
  - **assembly** `executor_build_20260413062031_e8ff46f0:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters when the compiler found an exact backend; otherwise build the smallest lane-consistent kernel the plan requires.
  ...
  "trellis.models.quanto_option"
      ...
      - `route_helper`: trellis.models.quanto_option.price_quanto_option_analytical_from_market_state
  - **validation** `executor_build_20260413062031_e8ff46f0:validation`
  ...
  - **output** `executor_build_20260413062031_e8ff46f0:output`
