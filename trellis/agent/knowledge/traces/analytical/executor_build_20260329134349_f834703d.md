# Analytical Trace: `executor_build_20260329134349_f834703d`
- Trace type: `analytical`
- Route family: `pde_solver`
- Route name: `pde_theta_1d`
- Model: `pde_solver`
- Status: `warning`
- Created at: `2026-03-29T13:44:10.068564+00:00`
- Updated at: `2026-03-29T13:44:10.233637+00:00`
- Task ID: `executor_build_20260329134349_f834703d`
...
## Steps
- **trace** `executor_build_20260329134349_f834703d:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329134349_f834703d
  - Outputs:
    - `route`: {
  "family": "pde_solver",
  "model": "pde_solver",
  "name": "pde_theta_1d"
    ...
    - `status`: warning
  - **semantic_resolution** `executor_build_20260329134349_f834703d:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329134349_f834703d:root`
    - Notes:
  ...
  "route": "pde_theta_1d"
      ...
      - `route_family`: pde_solver
      - `route_name`: pde_theta_1d
  - **instruction_lifecycle** `executor_build_20260329134349_f834703d:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329134349_f834703d:decomposition`
  ...
  - **assembly** `executor_build_20260329134349_f834703d:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.pde.theta_method"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329134349_f834703d:validation`
  ...
  - **output** `executor_build_20260329134349_f834703d:output`
