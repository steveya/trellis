...
- **trace** `monte_carlo_correlated_basket_monte_carlo_basket_option_20260328T185935493451Z:root`
  ...
  "name": "correlated_basket_monte_carlo"
    ...
    - `status`: ok
  - **semantic_resolution** `monte_carlo_correlated_basket_monte_carlo_basket_option_20260328T185935493451Z:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `monte_carlo_correlated_basket_monte_carlo_basket_option_20260328T185935493451Z:root`
    - Notes:
  ...
  "MonteCarloPathRequirement"
    ...
    - Outputs:
      ...
      - `route_family`: monte_carlo
      - `route_name`: correlated_basket_monte_carlo
  - **decomposition** `monte_carlo_correlated_basket_monte_carlo_basket_option_20260328T185935493451Z:decomposition`
  ...
  - **assembly** `monte_carlo_correlated_basket_monte_carlo_basket_option_20260328T185935493451Z:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.monte_carlo.semantic_basket"
      ...
      - `route_helper`: trellis.models.monte_carlo.semantic_basket.price_ranked_observation_basket_monte_carlo
  - **validation** `monte_carlo_correlated_basket_monte_carlo_basket_option_20260328T185935493451Z:validation`
  ...
  - **output** `monte_carlo_correlated_basket_monte_carlo_basket_option_20260328T185935493451Z:output`
