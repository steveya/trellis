# Analytical Trace: `executor_build_20260413025312_606c40c6`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `analytical_black76`
- Model: `analytical`
- Status: `warning`
- Created at: `2026-04-13T02:53:13.736839+00:00`
- Updated at: `2026-04-13T02:53:13.781681+00:00`
- Task ID: `executor_build_20260413025312_606c40c6`
...
## Steps
- **trace** `executor_build_20260413025312_606c40c6:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260413025312_606c40c6
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "analytical",
  "name": "analytical_black76"
    ...
    - `status`: warning
  - **semantic_resolution** `executor_build_20260413025312_606c40c6:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260413025312_606c40c6:root`
    - Notes:
  ...
  "route": "analytical_black76"
      ...
      - `route_family`: analytical
      - `route_name`: analytical_black76
  - **instruction_lifecycle** `executor_build_20260413025312_606c40c6:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260413025312_606c40c6:decomposition`
  ...
  - **assembly** `executor_build_20260413025312_606c40c6:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters when the compiler found an exact backend; otherwise build the smallest lane-consistent kernel the plan requires.
  ...
  "trellis.models.rate_style_swaption"
      ...
      - `route_helper`: trellis.models.rate_style_swaption.price_swaption_black76
  - **validation** `executor_build_20260413025312_606c40c6:validation`
  ...
  - **output** `executor_build_20260413025312_606c40c6:output`
