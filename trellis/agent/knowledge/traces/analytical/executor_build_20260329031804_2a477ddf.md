# Analytical Trace: `executor_build_20260329031804_2a477ddf`
- Trace type: `analytical`
- Route family: `pde_solver`
- Route name: `pde_theta_1d`
- Model: `pde_solver`
- Status: `warning`
- Created at: `2026-03-29T03:18:24.410468+00:00`
- Updated at: `2026-03-29T03:18:24.538413+00:00`
- Task ID: `executor_build_20260329031804_2a477ddf`

## Context
- `class_name`: 'EuropeanOptionFEMPayoff'
...
- `spec_name`: 'EuropeanOptionFEMSpec'

## Steps
- **trace** `executor_build_20260329031804_2a477ddf:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329031804_2a477ddf
  - Outputs:
    - `route`: {
  "family": "pde_solver",
  "model": "pde_solver",
  "name": "pde_theta_1d"
    ...
    - `status`: warning
  - **semantic_resolution** `executor_build_20260329031804_2a477ddf:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329031804_2a477ddf:root`
    - Notes:
  ...
  "route": "pde_theta_1d"
      ...
      - `route_family`: pde_solver
      - `route_name`: pde_theta_1d
  - **instruction_lifecycle** `executor_build_20260329031804_2a477ddf:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329031804_2a477ddf:decomposition`
  ...
  - **assembly** `executor_build_20260329031804_2a477ddf:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.pde.theta_method"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329031804_2a477ddf:validation`
  ...
  - **output** `executor_build_20260329031804_2a477ddf:output`
