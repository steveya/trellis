...
- `spec_name`: 'RubinsteinLogGridBarrierSpec'

## Steps
- **trace** `executor_build_20260329031029_e402a80c:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260329031029_e402a80c
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "analytical",
  "name": "analytical_black76"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260329031029_e402a80c:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260329031029_e402a80c:root`
    - Notes:
  ...
  "route": "analytical_black76"
      ...
      - `route_family`: analytical
      - `route_name`: analytical_black76
  - **instruction_lifecycle** `executor_build_20260329031029_e402a80c:instruction_lifecycle`
  ...
  - **decomposition** `executor_build_20260329031029_e402a80c:decomposition`
  ...
  - **assembly** `executor_build_20260329031029_e402a80c:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.core.date_utils"
      ...
      - `route_helper`: None
  - **validation** `executor_build_20260329031029_e402a80c:validation`
  ...
  - **output** `executor_build_20260329031029_e402a80c:output`
