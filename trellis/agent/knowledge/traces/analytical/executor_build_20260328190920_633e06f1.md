# Analytical Trace: `executor_build_20260328190920_633e06f1`
- Trace type: `analytical`
- Route family: `analytical`
- Route name: `quanto_adjustment_analytical`
- Model: `unknown`
- Status: `ok`
- Created at: `2026-03-28T19:09:20.973736+00:00`
- Updated at: `2026-03-28T19:09:21.131527+00:00`
- Task ID: `executor_build_20260328190920_633e06f1`
...
## Steps
- **trace** `executor_build_20260328190920_633e06f1:root`
  ...
  - Inputs:
    ...
    - `task_id`: executor_build_20260328190920_633e06f1
  - Outputs:
    - `route`: {
  "family": "analytical",
  "model": "unknown",
  "name": "quanto_adjustment_analytical"
    ...
    - `status`: ok
  - **semantic_resolution** `executor_build_20260328190920_633e06f1:semantic_resolution`
    - Label: Resolve contract and route
    - Status: `ok`
    - Parent: `executor_build_20260328190920_633e06f1:root`
    - Notes:
  ...
  "discount_factor_from_zero_rate"
    ...
    - Outputs:
      ...
      - `route_family`: analytical
      - `route_name`: quanto_adjustment_analytical
  - **decomposition** `executor_build_20260328190920_633e06f1:decomposition`
  ...
  - **assembly** `executor_build_20260328190920_633e06f1:assembly`
...
- Use approved Trellis imports only. Prefer thin adapters over bespoke numerical kernels.
  ...
  "trellis.models.analytical.quanto"
      ...
      - `route_helper`: trellis.models.analytical.quanto.price_quanto_option_analytical
  - **validation** `executor_build_20260328190920_633e06f1:validation`
  ...
  - **output** `executor_build_20260328190920_633e06f1:output`
