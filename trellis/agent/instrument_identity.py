...
_INSTRUMENT_PATTERNS: tuple[tuple[str, str], ...] = (
    ...
    ("nth to default", "nth_to_default"),
    ("first-to-default", "nth_to_default"),
    ("first to default", "nth_to_default"),
    ("second-to-default", "nth_to_default"),
    ("second to default", "nth_to_default"),
    ("basket cds", "nth_to_default"),
    ...
    ("black_scholes_digital", "digital_option"),
    ("black scholes digital", "digital_option"),
    ("bs_digital", "digital_option"),
    ("black_scholes", "european_option"),
    ("black scholes", "european_option"),
    ("gbm calls", "european_option"),
    ("gbm puts", "european_option"),
    ("gbm call", "european_option"),
    ("gbm put", "european_option"),
    ("kou double-exponential", "european_option"),
    ("kou double exponential", "european_option"),
    ("kou_fft", "european_option"),
    ("kou mc", "european_option"),
    ("kou_mc", "european_option"),
    ("kou", "european_option"),
    ("merton jump-diffusion", "european_option"),
    ("merton jump diffusion", "european_option"),
    ("merton option", "european_option"),
    ("jump-diffusion call", "european_option"),
    ("jump diffusion call", "european_option"),
    ("jump-diffusion option", "european_option"),
    ("jump diffusion option", "european_option"),
    ("sabr mc simulation", "european_option"),
    ("sabr hagan", "european_option"),
    ("hagan implied vol", "european_option"),
    ("variance gamma", "european_option"),
    ("variance_gamma", "european_option"),
    ("vg_cos", "european_option"),
    ("vg mc", "european_option"),
    ("vg_mc", "european_option"),
    ("madan carr chang", "european_option"),
    ("madan_carr_chang", "european_option"),
    ("cgmy", "european_option"),
    ("tempered stable", "european_option"),
    ("bates model", "european_option"),
    ("bates_fft", "european_option"),
    ("bates mc", "european_option"),
    ("bates_mc", "european_option"),
    ...
    ("asian", "asian_option"),
    ("lookback option", "lookback_option"),
    ("lookback", "lookback_option"),
    ("variance swap", "variance_swap"),
    ("heston", "heston_option"),
    ("cev", "european_option"),
    ("cdo", "cdo"),
    ("credit index option", "credit_index_option"),
    ("black on spread", "credit_index_option"),
    ("black_on_spread", "credit_index_option"),
    ("mc_credit_index", "credit_index_option"),
    ("wrong-way risk", "counterparty_cva"),
    ("wrong way risk", "counterparty_cva"),
    ("cva", "counterparty_cva"),
    ("xva", "counterparty_cva"),
    ...
    ("digital option", "digital_option"),
    ("digital", "digital_option"),
    ("compound option", "compound_option"),
    ("chooser option", "chooser_option"),
    ("chooser", "chooser_option"),
    ("cliquet option", "cliquet_option"),
    ("cliquet", "cliquet_option"),
