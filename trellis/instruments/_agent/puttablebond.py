...
Implementation target: callable_tree_symmetry."""
    ...
    def evaluate(self, market_state: MarketState) -> float:
        ...
        if market_state.discount is None:
            raise ValueError("PuttableBondPayoff requires a discount curve in market_state")
        ...
        if horizon <= 0.0:
            raise ValueError("Puttable bond maturity must be after settlement")
        ...
        return max(lattice_value, straight_bond_value)
